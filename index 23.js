...
function buildConfigPage(baseUrl) {
  ...
  h += '<footer>Eclipse Radio Addon v1.0.4 \u2022 <a href="https://www.radio-browser.info" target="_blank" rel="noopener noreferrer">Radio Browser</a> \u2022 <a href="https://somafm.com" target="_blank" rel="noopener noreferrer">SomaFM</a> \u2022 <a href="https://tunein.com" target="_blank" rel="noopener noreferrer">TuneIn</a> \u2022 <a href="' + baseUrl + '/health" target="_blank" rel="noopener noreferrer">Health</a></footer>';
...
app.get('/u/:token/manifest.json', tokenMiddleware, function(req, res) {
  res.json({ id: 'com.eclipse.radio.' + req.params.token.slice(0, 8), name: 'Radio', version: '1.0.4', description: 'Live radio from Radio Browser, SomaFM & TuneIn. Search by name, frequency, genre, country, or language.', icon: getBaseUrl(req) + '/radio-icon.png?v=2', resources: ['search', 'stream', 'catalog'], types: ['track', 'album', 'artist', 'playlist'] });
});
