...
app.get('/u/:token/manifest.json', tokenMiddleware, function(req, res) {
  res.json({ id: 'com.eclipse.radio.' + req.params.token.slice(0, 8), name: 'Radio', version: '1.0.4', description: 'Live radio from Radio Browser, SomaFM & TuneIn. Search by name, frequency, genre, country, or language.', icon: getBaseUrl(req) + '/icon.png', resources: ['search', 'stream', 'catalog'], types: ['track', 'album', 'artist', 'playlist'] });
});
